export const config = {
  ...
  stories: [
    ...
    {
      id: "s2",
      slug: "loop-tech-y-combinator",
      category: "LOGRO",
      title: "Loop Tech seleccionado en Y Combinator",
      summary: "La startup agro-tech expandirá sus operaciones a México y Colombia.",
      content: "Loop Tech, la startup ecuatoriana fundada por Sofía Torres, ha sido oficialmente seleccionada para formar parte del prestigioso batch de verano de Y Combinator. Este logro marca un antes y un después para el ecosistema tecnológico local.\n\nCon esta inversión y mentoría, la empresa planea escalar rápidamente sus soluciones de inteligencia artificial aplicada a la gestión hídrica agrícola. El objetivo para los próximos 12 meses es consolidar su presencia en Ecuador y comenzar operaciones piloto en mercados agrícolas clave de México y Colombia, ayudando a cientos de agricultores a ahorrar agua y optimizar sus cultivos.",
